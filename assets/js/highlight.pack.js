...
},{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,c,t]}]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
...
preprocessor:l,strings:c,keywords:m}}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
